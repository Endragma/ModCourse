...
import com.icarocampos.modcourse.world.feature.ModConfiguredFeatures;
...
//Contains the actual biomes configs.
public class ModBiomes
{
    //Register biome as part of the world generation process.
    ...
    //Contains all properties of the biome being created, such as rain type, sky and water colors, if it will have ores and etc.
    public static Biome makeOilBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale)
    {
