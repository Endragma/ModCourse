package com.icarocampos.modcourse.world.feature;
...
//Contains features that can be added to any biomes later, like new types of lakes, mines, locations or rock formations.
