...
import com.icarocampos.modcourse.world.biome.ModConfiguredSurfaceBuilders;
...
//Makes the biomes be generated in the game world.
...
public class ModBiomeGeneration
{
    ...
    {
        Registry.register(WorldGenRegistries.CONFIGURED_SURFACE_BUILDER, configuredSurfaceBuilderRL, ModSurfaceBuilders.LOGGING_DEFAULT.get().func_242929_a(
