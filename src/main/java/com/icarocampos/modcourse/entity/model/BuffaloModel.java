package com.icarocampos.modcourse.entity.model;
...
public class BuffaloModel<T extends BuffaloEntity> extends EntityModel<T>
{
    ...
    //The position for every block and joints in this entity.
    public BuffaloModel() {
        textureWidth = 71;
        textureHeight = 45;
    ...
    //Body parts rotations to enable this entity to move its legs while walking and head while looking.
    @Override
